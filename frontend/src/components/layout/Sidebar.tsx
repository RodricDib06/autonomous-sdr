...
import {
  ...
  Settings, Zap, ChevronRight, LogOut, GitBranch, FlaskConical, Target, Radio, MessageSquare, ShieldCheck, ListOrdered, History, Flag,
} from "lucide-react";
...
const navItems = [
  ...
  { to: "/campaigns", icon: Flag, label: "Campaigns" },
